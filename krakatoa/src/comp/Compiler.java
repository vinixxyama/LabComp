...
public class Compiler {
	...
	private void compositeStatement(Type type, String name) {
	...
	private void statementList(Type type, String name) {
	...
	private void statement(Type type, String name) {
		/*
		...
		case WRITELN:
			...
			break;
		case IF:
			ifStatement(type, name);
			break;
		case BREAK:
			breakStatement();
			break;
		case WHILE:
			whileStatement(type, name);
			break;
		case SEMICOLON:
			nullStatement();
			break;
		case LEFTCURBRACKET:
			compositeStatement(type, name);
			break;
		default:
	...
	private void whileStatement(Type type, String name) {
	...
	private void ifStatement(Type type, String name) {
	...
	private Expr factor() {
		...
		case IDENT:
			...
			lexer.nextToken();
			//executa busca para ver se variavel foi declarada.
			// Iterator<Variable> aux = lv.elements();
			// int flag = 0;
			// while(aux.hasNext()){
			// 	Variable aux2 = aux.next();
			// 	if(firstId.equals(aux2.getName())){
			// 		flag = 1;
			// 	}
			// }
			// if(flag == 1){
